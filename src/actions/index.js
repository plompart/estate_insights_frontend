...
var host = 'http://rossum.knbit.edu.pl:32005';
...
//http://rossum.knbit.edu.pl:32005
  ...
  let request = axios.post(host + '/predict?',{
...
export const getEquipmentNames = () => {
  let request = axios.get(host + `/additional_features`);
  return {
...
export const submitHistData = (type) => {
  let request = axios.get(host + `/${type}?nb_bins=6`);
...
export const getAdditionalFeatures = () => {
  let request = axios.get(host + `/pickable_features`);
...
export const getBubbleGraphData = () => {
  let request = axios.get(host + `/scatter?` +
...
export const getAllOffers = () => {
  let request = axios.get(host + `/all_offers`);
...
export const getDistrictData = () => {
  let request = axios.get(host + `/districts_means`);
